...
export const MyCommandCell = props => {
  ...
  return inEdit ? <td className="k-command-cell">
      ...
      <button className="k-button k-grid-remove-command" onClick={() => // eslint-disable-next-line no-restricted-globals
       {if(confirm("Confirm deleting: " + dataItem.ProductName)) { props.remove(dataItem)}}}>
        Remove
      </button>
    </td>;
};