...
function Table({ columns, data, updateMyData, skipReset, setData, renderSubmit, resetData, loadingSubmit, loadingGet }) {
  ...
  return (
    ...
    <div className="crud-ui-bar">
      ...
      <CsvDownload className = "ui labeled icon button" data={data} filename = "SkillsTable.csv"><i className = "download icon"></i> Download as CSV File</CsvDownload>
...
const SkillsTableEdit = () => {
    ...
    () => [
      {
        ...
        columns: [
          ...
          {
            Header: 'Manager Proficiency Rating',
          ...
          {
            Header: 'Self Proficiency Rating',
            accessor: 'selfRating',
            filter: 'fuzzyText'
  ...
  useEffect(async () => {
    await axios.get('https://s9596ybec7.execute-api.us-east-1.amazonaws.com/dev', {
      headers : {
  ...
  const renderSubmit = async () => {
    ...
    await axios.put('https://s9596ybec7.execute-api.us-east-1.amazonaws.com/dev', payload, {
      headers : {
        "Content-Type": "application/json",
        "Accept": "application/json"
      }
...
export default SkillsTableEdit